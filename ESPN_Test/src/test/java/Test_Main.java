...
public class Test_Main {
    ...
    String PERFECTO_HOST        = System.getProperty("np.testHost", "perfectomobile.com");
    String PERFECTO_USER        = System.getProperty("np.testUsername", "");
    String PERFECTO_PASSWORD    = System.getProperty("np.testPassword", "");
