...
public class Test_Main {
    ...
    String PERFECTO_HOST        = System.getProperty("np.testHost", "wyn.perfectomobile.com");
    String PERFECTO_USER        = System.getProperty("np.testUsername", "Krishnaraj.Kaliyamoorthy@wyn.com");
    String PERFECTO_PASSWORD    = System.getProperty("np.testPassword", "Perfecto123");
